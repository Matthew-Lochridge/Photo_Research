...
% Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
    ...
    switch specifier
        ...
        case 'backlight'
            command = append('B',num2str(user_input));
        ...
        case 'measurement_label'
            command = append('L',num2str(user_input));
        ...
        case 'addon_1'
            command = append('SA',num2str(user_input));
        case 'addon_2'
            command = append('SB',num2str(user_input));
        case 'addon_3'
            command = append('SC',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'dark_mode'
            command = append('SD',num2str(user_input));
        ...
        case 'exposure_time'
            command = append('SE',num2str(user_input));
        ...
        case 'aperture'
            command = append('SF',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'gain'
            command = append('SG',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'sensitivity'
            command = append('SH',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'sync_freq'
            command = append('SK',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'cycles'
            command = append('SN',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'observer'
            command = append('SO',num2str(user_input));
        ...
        case 'accessory'
            command = append('SP',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code)
        case 'sync_mode'
            command = append('SS',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'unit_system'
            command = append('SU',num2str(user_input));
        ...
        % Response: 0000[CR][LF] If all OK, else NNNN[CR][LF] (NNNN = Error code) 
        case 'shutter_mode'
            command = append('SZ',num2str(user_input));
        ...
        case 'contrast'
            ...
            command = append('X',num2str(user_input));
