% Plot data from PR-655
% Inputs:
%   code = data code (PR-655 manual)
%   data_struct = struct with data fields

function plot_data(data_code,data_struct)
    ...
    switch data_code
        ...
        %   00000,0,1.865e+01,0.4035,0.4202
            ...
            data_struct.unit_code = data_array(2);
            data_struct.Y = data_array(3);
            data_struct.x = data_array(4);
            data_struct.y = data_array(5);
        ...
        %   00000,0,6.136e+01,1.865e+01,2.681e+01
            ...
            data_struct.error_code = data_array(1);
            data_struct.unit_code = data_array(2);
            data_struct.X = data_array(3);
            data_struct.Y = data_array(4);
            data_struct.Z = data_array(5);
        ...
        %   00000,0,1.865e+01,0.2231,0.5227
            ...
            data_struct.unit_code = data_array(2);
            data_struct.Y = data_array(3);
            data_struct.u_prime = data_array(4);
            data_struct.v_prime = data_array(5);
        ...
        %   00000,0,1.865e+01,3757,0.0129
            ...
            data_struct.unit_code = data_array(2);
            data_struct.Y = data_array(3);
            data_struct.CCT = data_array(4);
            data_struct.locus_dev = data_array(5);
        ...
        %   00000,0,2.041e+01,0.4089,0.4151,0.2283,0.5215
            ...
            data_struct.x = data_array(4);
            data_struct.y = data_array(5);
            data_struct.u_prime = data_array(6);
            data_struct.v_prime = data_array(7);
        ...
        %   00000,0,2.646e+03,0.2081,0.3519
            ...
            data_struct.unit_code = data_array(2);
            data_struct.Y = data_array(3);
            data_struct.u = data_array(4);
            data_struct.v = data_array(5);
        ...
        %   00000,0,2.041e+01,0.4089,0.4151,0.2283,0.3477
            ...
            data_struct.x = data_array(4);
            data_struct.y = data_array(5);
            data_struct.u = data_array(6);
            data_struct.v = data_array(7);
        ...
        %   00000,Fast,16500 msec
            ...
            data_struct.error_code = data_array(1);
            data_struct.gain = data_array(2);
            data_struct.exposure_time = data_array(3);
        ...
        %   00000,User Sync,120.00 Hertz
            ...
            data_struct.error_code = data_array(1);
            data_struct.sync_mode = data_array(2);
            data_struct.sync_freq = data_array(3);
        ...
        %   00000,67065106
            ...
            data_struct.error_code = data_array(1);
            data_struct.serial_num = data_array(2);
        ...
        %   00000,PR-655
            ...
            data_struct.error_code = data_array(1);
            data_struct.model = data_array(2);
        ...
        % 00000,1,4
            ...
            data_struct.error_code = data_array(1);
            data_struct.num_accessories = data_array(2);
            data_struct.num_apertures = data_array(3);
        ...
        % 00000,2.22D
            ...
            data_struct.error_code = data_array(1);
            data_struct.software_version = data_array(2);
        ...
        %   00000,0,MS-75,Primary,Luminance,Radiance
            ...
            data_struct.error_code = data_array(1);
            data_struct.accessory_id = data_array(2);
            data_struct.accessory_name = data_array(3);
            data_struct.accessory_type = data_array(4);
            data_struct.photometry_mode = data_array(5);
            data_struct.radiometry_mode = data_array(6);
        ...
        %   00000,201,0.00,380,780,2,256,7,247
            ...
            data_struct.error_code = data_array(1);
            data_struct.num_points = data_array(2);
            data_struct.bandwidth = data_array(3);
            data_struct.wl_start = data_array(4);
            data_struct.wl_stop = data_array(5);
            data_struct.wl_step = data_array(6);
            data_struct.num_pixels = data_array(7);
            data_struct.pix_start = data_array(8);
            data_struct.pix_stop = data_array(9);
        ...
        %   6
            ...
            data_struct.num_stored_measurements = data_array(1);
        ...
        % Output Example:
            ...
            data_struct.measurement_id = data_array(1);
            data_struct.measurement_date = data_array(2);
            data_struct.measurement_time = data_array(3);
